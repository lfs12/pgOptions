...
********IMPORTANTE! 
ASEGURARSE DE TENER EM LA RAIZ LAS CARPETAS "db_updates" y "db_backups" (CREA MANUAL O EJECUTA ELPROGRAMA .bat)
...
* Ejecutar Scripts en una BD a partir de un archivo sql.
* Importar o restaurar una BD a partir de un archivo sql.
...
NOTAS:
***Todos los archivos deben estar en formato SQL***
***Los directorios deben permanecer en el orden establecido***
